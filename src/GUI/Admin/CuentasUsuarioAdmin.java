...
public class CuentasUsuarioAdmin extends javax.swing.JFrame {

    private String nombre, apellido, DNI, correo, contraseña;
    
    public CuentasUsuarioAdmin(VistaAdmin admin) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                VistaAdmin admin = new VistaAdmin(acceso);
                new CuentasUsuarioAdmin(admin).setVisible(true);
            }
        });
    }
